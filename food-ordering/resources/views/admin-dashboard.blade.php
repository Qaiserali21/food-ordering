                    ...
                    <div class="row">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        <div>
                                            <img src="{{ asset('import/assets/images/food/online-order-1.png') }}" class="w-80 mr-20" alt="" />
                                        </div>
                                        <div>
                        ...
                        <div class="col-xxxl-3 col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        <div>
                                            <img src="{{ asset('import/assets/images/food/online-order-2.png') }}" class="w-80 mr-20" alt="" />
                                        </div>
                                        <div>
                        ...
                        <div class="col-xxxl-3 col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        <div>
                                            <img src="{{ asset('import/assets/images/food/online-order-3.png') }}" class="w-80 mr-20" alt="" />
                                        </div>
                                        <div>
                        ...
                        <div class="col-xxxl-3 col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        <div>
                                            <img src="{{ asset('import/assets/images/food/online-order-4.png') }}" class="w-80 mr-20" alt="" />
                                        </div>
                                        <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="review-tx">
                                                        <div class="d-flex mb-10">
                                                            <img src="{{ asset('import/assets/images/avatar/1.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="" />
                                                            <div>
                                                    ...
                                                    <img src="{{ asset('import/assets/images/food/dish-1.png') }}" class="dish-img" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box p-0">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="review-tx">
                                                        <div class="d-flex mb-10">
                                                            <img src="{{ asset('import/assets/images/avatar/2.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="" />
                                                            <div>
                                                    ...
                                                    <img src="{{ asset('import/assets/images/food/dish-2.png') }}" class="dish-img" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box p-0">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="review-tx">
                                                        <div class="d-flex mb-10">
                                                            <img src="{{ asset('import/assets/images/avatar/3.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="" />
                                                            <div>
                                                    ...
                                                    <img src="{{ asset('import/assets/images/food/dish-3.png') }}" class="dish-img" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box p-0">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="review-tx">
                                                        <div class="d-flex mb-10">
                                                            <img src="{{ asset('import/assets/images/avatar/4.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="" />
                                                            <div>
                                                    ...
                                                    <img src="{{ asset('import/assets/images/food/dish-4.png') }}" class="dish-img" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box p-0">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="review-tx">
                                                        <div class="d-flex mb-10">
                                                            <img src="{{ asset('import/assets/images/avatar/5.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="" />
                                                            <div>
                                                    ...
                                                    <img src="{{ asset('import/assets/images/food/dish-5.png') }}" class="dish-img" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xxxl-5 col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body pt-0">
                                    <div class="mb-5">
                                        <img class="rounded img-fluid" src="{{ asset('import/assets/images/food/img1.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="pt-30">
                                        ...
                                        <div class="bb-1 pb-10  d-lg-flex d-block justify-content-between">
                                            <div class="d-flex">
                                                <img src="{{ asset('import/assets/images/avatar/7.jpg') }}" class="w-40 h-40 mr-10 rounded100" alt="">
                                                <div>
