					  ...
					  <div class="media-list media-list-divided media-list-hover">
						<div class="media align-items-center">
						  ...
						  <a class="avatar avatar-lg status-success" href="#">
							<img src="{{ asset('import/assets/images/avatar/1.jpg') }}" alt="...">
						  </a>
						  ...
						  <div class="media-right gap-items">
							<a class="media-action lead" href="#" data-toggle="tooltip" title="" data-original-title="Orders"><i class="fas fa-shopping-cart"></i></a>
							<a class="media-action lead" href="#" data-toggle="tooltip" title="" data-original-title="Receipts"><i class="fas fa-receipt"></i></a>

							<div class="btn-group">
							  <a class="media-action lead" href="#" data-toggle="dropdown"><i class="fas fa-ellipsis-v"></i></a>
						...
						<div class="media align-items-center">
						  ...
						  <a class="avatar avatar-lg" href="#">
							<img src="{{ asset('import/assets/images/avatar/2.jpg') }}" alt="...">
						  </a>
						...
						<div class="media align-items-center">
						  ...
						  <a class="avatar avatar-lg status-warning" href="#">
							<img src="{{ asset('import/assets/images/avatar/3.jpg') }}" alt="...">
						  </a>
						...
						<div class="media align-items-center">
						  <span class="badge badge-dot badge-danger"></span>
						  <a class="avatar avatar-lg status-success" href="#">
							<img src="{{ asset('import/assets/images/avatar/4.jpg') }}" alt="...">
						  </a>
				...
				<div class="col-12">
				  ...
				  <div class="col-12 col-lg-3">
					<div class="box ribbon-box">
					  ...
					  <div class="box-header no-border p-0">				
						<a href="#">
						  <img class="img-fluid" src="{{ asset('import/assets/images/avatar/1(1).jpg') }}" alt="">
						</a>
					  </div>
					  <div class="box-body">
							<div class="user-contact list-inline text-center">
								<a href="#" class="btn btn-circle mb-5 btn-facebook"><i class="fab fa-facebook-f"></i></a>
								<a href="#" class="btn btn-circle mb-5 btn-instagram"><i class="fab fa-instagram"></i></a>
								<a href="#" class="btn btn-circle mb-5 btn-twitter"><i class="fab fa-twitter"></i></a>
								<a href="#" class="btn btn-circle mb-5 btn-warning"><i class="far fa-envelope"></i></a>				
							</div>
				  ...
				  <div class="col-12 col-lg-3">
					<div class="box ribbon-box">
					  ...
					  <div class="box-header no-border p-0">				
						<a href="#">
						  <img class="img-fluid" src="{{ asset('import/assets/images/avatar/2 (1).jpg') }}" alt="">
						</a>
					  </div>
					  <div class="box-body">
						  <div class="text-center">
				  ...
				  <div class="col-12 col-lg-3">
					<div class="box ribbon-box">
					  ...
					  <div class="box-header no-border p-0">				
						<a href="#">
						  <img class="img-fluid" src="{{ asset('import/assets/images/avatar/3 (1).jpg') }}" alt="">
						</a>
					  </div>
					  <div class="box-body">
						  <div class="text-center">
				  ...
				  <div class="col-12 col-lg-3">
					<div class="box">
					  <div class="box-header no-border p-0">				
						<a href="#">
						  <img class="img-fluid" src="{{ asset('import/assets/images/avatar/4 (1).jpg') }}" alt="">
						</a>
					  </div>
					  <div class="box-body">
						  <div class="text-center">
