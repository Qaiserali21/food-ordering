                ...
                <div class="multinav">
					...
					<span class="pull-right-container">
					  <i class="fa fa-angle-right pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="http://127.0.0.1:8000/pages/order"><i class="fas fa-angle-double-right"></i>Order List</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/order_details"><i class="fas fa-angle-double-right"></i>Order Details</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
					...
					<span class="pull-right-container">
					  <i class="fa fa-angle-right pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="http://127.0.0.1:8000/pages/add_new_menu"><i class="fas fa-angle-double-right"></i>Add New Menu</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/menu_list"><i class="fas fa-angle-double-right"></i>Menu List</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/categories"><i class="fas fa-angle-double-right"></i>Categories</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
					...
					<span class="pull-right-container">
					  <i class="fa fa-angle-right pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="http://127.0.0.1:8000/pages/customer"><i class="fas fa-angle-double-right"></i>Customer</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/members"><i class="fas fa-angle-double-right"></i>Members</a></li>
                                </ul>
                            </li>
                            <li>
					...
					<span class="pull-right-container">
					  <i class="fa fa-angle-right pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="http://127.0.0.1:8000/pages/products"><i class="fas fa-angle-double-right"></i>Products</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/product_cart"><i class="fas fa-angle-double-right"></i>Products Cart</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/product_edit"><i class="fas fa-angle-double-right"></i>Products Edit</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/products_details"><i class="fas fa-angle-double-right"></i>Product Details</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/products_orders"><i class="fas fa-angle-double-right"></i>Product Orders</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/products_checkout"><i class="fas fa-angle-double-right"></i>Products Checkout</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/Invoices"><i class="fas fa-angle-double-right"></i>Invoice</a></li>
                                    <li><a href="http://127.0.0.1:8000/pages/invoice_list"><i class="fas fa-angle-double-right"></i>Invoice List</a></li>
                                </ul>
                            </li>
					  ...
					  <i class="fa fa-angle-right pull-right"></i>
							...
							<span class="pull-right-container">
								<i class="fa fa-angle-right pull-right"></i>
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="widgets_blog.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Blog</a></li>
                                            <li><a href="widgets_chart.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Chart</a></li>
                                            <li><a href="widgets_list.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>List</a></li>
                                            <li><a href="widgets_social.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Social</a></li>
                                            <li><a href="widgets_statistic.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>tatistic</a></li>
                                            <li><a href="widgets_weather.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Weather</a></li>
                                            <li><a href="widgets.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Widgets</a></li>
                                        </ul>
                                    </li>
                                    <li class="treeview">
                                        <a href="#">
							...
							<span class="pull-right-container">
								<i class="fa fa-angle-right pull-right"></i>
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="component_modals.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Modals</a></li>
                                            <li><a href="component_sweatalert.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Sweet Alert</a></li>
                                            <li><a href="component_notification.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Toastr</a></li>
                                        </ul>
                                    </li>
                                    <li class="treeview">
                                        <a href="#">
							...
							<span class="pull-right-container">
								<i class="fa fa-angle-right pull-right"></i>
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="extra_calendar.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Calendar</a></li>
                                            <li><a href="contact_app.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Contact List</a></li>
                                            <li><a href="contact_app_chat.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Chat</a></li>
                                            <li><a href="extra_taskboard.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Todo</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="email_index.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Emails</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
					  ...
					  <i class="fa fa-angle-right pull-right"></i>
							...
							<span class="pull-right-container">
								<i class="fa fa-angle-right pull-right"></i>
                                        ...
                                        <ul class="treeview-menu">
                                            <li><a href="component_bootstrap_switch.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Bootstrap Switch</a></li>
                                            <li><a href="component_date_paginator.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Date Paginator</a></li>
                                            <li><a href="component_media_advanced.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Advanced Medias</a></li>
                                            <li><a href="component_rangeslider.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Range Slider</a></li>
                                            <li><a href="component_rating.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Ratings</a></li>
                                            <li><a href="component_animations.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Animations</a></li>
                                            <li><a href="extension_fullscreen.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Fullscreen</a></li>
                                            <li><a href="extension_pace.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Pace</a></li>
                                            <li><a href="component_nestable.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Nestable</a></li>
                                            <li><a href="component_portlet_draggable.html"><i class="fa fa-code mr-2" aria-hidden="true"></i>Draggable Portlets</a></li>
                                        </ul>
                                    </li>
                                    <li class="treeview">
                                        <a href="#">
                        ...
                        <div class="sidebar-widgets">
                            <div class="mx-25 mb-30 pb-20 side-bx bg-primary bg-food-dark rounded20">
                                <div class="text-center">
                                    <img src="{{ asset('import/assets/images/res-menu.png') }}" class="sideimg" alt="">
