<footer class="main-footer">
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{ asset('import/assets/images/avatar/2.jpg') }}" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="{{ asset('import/assets/images/avatar/3.jpg') }}" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
    ...
    <!-- Vendor JS -->
    <script src="{{ asset('import/assets/js/vendors.min.js') }}"></script>
    <script src="{{ asset('import/assets/js/pages/chat-popup.js') }}"></script>
    <script src="{{ asset('import/assets/vendor_components/apexcharts-bundle/dist/apexcharts.min.js') }}"></script>
    <script src="{{ asset('import/assets/icons/feather-icons/feather.min.js') }}"></script>

    <script src="{{ asset('import/assets/vendor_components/OwlCarousel2/dist/owl.carousel.js') }}"></script>
    ...
    <!-- Riday App -->
    <script src="{{ asset('import/assets/js/template.js') }}"></script>
